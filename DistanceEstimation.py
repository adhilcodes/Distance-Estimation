...
CAR_WIDTH = 16 #INCHES
MOTORBIKE_WIDTH = 16 #INCHES
TRUCK_WIDTH = 20 #INCHES
...
ref_car = cv.imread('ReferenceImages/image14.png')
ref_motorbike= cv.imread('ReferenceImages/image14.png')
ref_truck= cv.imread('ReferenceImages/image14.png')
...
motorbike_data = object_detector(ref_person)
motorbike_width_in_rf = motorbike_data[0][1]

truck_data = object_detector(ref_person)
